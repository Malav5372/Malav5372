## Hey👋 Nice to see you!
![Artificial Intelligence](https://img.shields.io/badge/AI-F7DF1E?style=flat&logo=AI&logoColor=black)
![Machine Learning](https://img.shields.io/badge/MachineLearning-3776AB?style=flat&logo=MachineLearning&logoColor=black)
...
### • [VisuNex](https://github.com/Malav5372/VisuNex) : VisuNex is a Text to image generation project that revolutionizes text-to-image generation by harnessing the power of the CLIP (Contrastive Language-Image Pre-Training) model developed by OpenAI. The core motive behind VisuNex is to empower users to infuse their user-defined aesthetics into the visuals it generates.
